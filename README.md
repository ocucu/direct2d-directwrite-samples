...
* So far, the solution's projects are configured for platform toolset Visual Studio 2022 (v143) and Windows SDK version: 10.0 (latest installed version). However it's not a problem if you want to reconfigure to other Windows SDK version and/or other platform toolset.  
